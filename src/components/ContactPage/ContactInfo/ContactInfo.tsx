...
export default function ContactInfo({ titleOpeningHours, titleContact, openingHours, addressLine, addressLine2, phone, mail }: ContactInfoProps) {
    return (
        <>
                ...
                <div className={`container ${styles.aboutInner}`}>
                    <div className={styles.contactInfoItem}>
                        ...
                        <div className={styles.phoneMail}>
                            ...
                            <a href="mailto:hello@gesicht.dk">
                                <span>
